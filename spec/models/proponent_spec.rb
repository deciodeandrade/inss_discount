...
RSpec.describe Proponent, type: :model do
  let(:address) { Address.new(street: 'Rua A', city: 'Cidade B', state: 'Estado C', zip_code: '12345-678', number: '123', neighborhood: 'Centro') }
  ...
  describe '.salary_ranges' do
    before do
      Proponent.create!(name: 'A', cpf: '111.111.111-11', birth_date: '1980-01-01', salary: 1000.0, inss_discount: 100.0, personal_contact: '9999-9999', reference_contact: '8888-8888', address: address)
      Proponent.create!(name: 'B', cpf: '222.222.222-22', birth_date: '1980-01-01', salary: 1500.0, inss_discount: 150.0, personal_contact: '9999-9999', reference_contact: '8888-8888', address: address)
      Proponent.create!(name: 'C', cpf: '333.333.333-33', birth_date: '1980-01-01', salary: 2500.0, inss_discount: 250.0, personal_contact: '9999-9999', reference_contact: '8888-8888', address: address)
      Proponent.create!(name: 'D', cpf: '444.444.444-44', birth_date: '1980-01-01', salary: 4000.0, inss_discount: 400.0, personal_contact: '9999-9999', reference_contact: '8888-8888', address: address)
      Proponent.create!(name: 'E', cpf: '555.555.555-55', birth_date: '1980-01-01', salary: 7000.0, inss_discount: 700.0, personal_contact: '9999-9999', reference_contact: '8888-8888', address: address)
    end
